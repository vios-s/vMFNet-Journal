...
from loaders.mms_dataloader_dg_aug_semiweakvol import get_dg_data_loaders
import models
...
# python train_weakvol.py -e 200 -bs 4 -c cp_compcsd2_100_tvA_weakvol/ -enc cp_unet_100_tvA/UNet.pth -t A -w CompCSD_12_weakvol_tvA2 -g 0
# k_un = 1
# k1 = 40
# k2 = 4

# python train_weakvol.py -e 1200 -bs 4 -c cp_compcsd2_5_tvA_weakvol/ -enc cp_unet_100_tvA/UNet.pth -t A -w CompCSD_12_weakvol_tvA2 -g 0
# k_un = 1
# k1 = 400
# k2 = 40

# python train_weakvol.py -e 2000 -bs 4 -c cp_compcsd2_2_tvA_weakvol/ -enc cp_unet_100_tvA/UNet.pth -t A -w CompCSD_12_weakvol_tvA2 -g 0
k_un = 4
k1 = 600
k2 = 80
    ...
    for epoch in range(epochs):
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img') as pbar:
            ...
            for imgs, true_masks, heart_label in train_loader:
                ...
                batch_loss = 0*reco_loss + 0*clu_loss  + loss_dice + loss_focal + 0.4*heart_weak_loss
                ...
                for i in range(k_un):
                    ...
                    un_batch_loss = 0*un_reco_loss + 0*un_clu_loss + 0.4*un_heart_weak_loss
