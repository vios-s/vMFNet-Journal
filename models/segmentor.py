...
# input the content and features of UNet
# concatenate the content and features and predict the segmentations mask

class Segmentor(nn.Module):
    def __init__(self, anatomy_out_channels, vc_num, num_classes, layer=8, bilinear=True):
        ...
        if self.layer==6: # 36x36
            ...
            input_channels =  vc_num + self.anatomy_out_channels
            out_channels = 64
