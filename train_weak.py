...
from loaders.mms_dataloader_dg_aug_weak import get_dg_data_loaders
import models
...
# python train_weak.py -e 200 -bs 4 -c cp_compcsd2_tvA_weak/ -enc cp_unet_100_tvA/UNet.pth -t A -w CompCSD_12weak_tvA2_all -g 0
    ...
    for epoch in range(epochs):
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img') as pbar:
            for imgs, true_masks, heart_label in train_loader:
                ...
                batch_loss = clu_loss + heart_weak_loss
