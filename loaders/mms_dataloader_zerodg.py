...
def get_data_loader_folder(data_folders, mask_folders, batch_size, new_size=224, test_num='D', num_workers=4):
    if test_num=='A':
        ...
        train_data_dirs = [data_folders[0], data_folders[3]]
        train_mask_dirs = [mask_folders[0], mask_folders[3]]
        test_data_dirs = [data_folders[4]]
        test_mask_dirs = [mask_folders[4]]
        un_train_re = Re_dir[1:3]
        train_re = [Re_dir[0], Re_dir[3]]
        test_re = [Re_dir[4]]
    ...
    train_unlabeled_dataset = ImageFolder(un_train_data_dirs, un_train_mask_dirs, ref_data_dirs, un_train_re, num_label=un_train_num, train=True, labeled=False)
