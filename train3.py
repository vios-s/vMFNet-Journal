...
# python train3.py -e 1200 -bs 4 -c cp_compcsd2_5_tvA/ -enc cp_unet_100_tvA/UNet.pth -t A -w CompCSD_4sigmoidvmfdecode_tvA2 -g 0
k_un = 1
k1 = 400
k2 = 40

# python train3.py -e 2000 -bs 4 -c cp_compcsd2_2_tvA/ -enc cp_unet_100_tvA/UNet.pth -t A -w CompCSD_12sigmoidvmfdecode_tvA2 -g 0
# k_un = 1
# k1 = 600
# k2 = 80
